...
public class IronGhostHide : IronGhostState
{
    public float MaxTime;
    public float Timer;
    public bool TimerIsActive;
    public IronGhostHide(EnemyStateMachine<IronGhostController> stateMachine, IronGhostController controller, string animName) : base(stateMachine, controller, animName)
    {
    }
