...
public class IronGhostLooking : IronGhostState
{
    public IronGhostLooking(EnemyStateMachine<IronGhostController> stateMachine, IronGhostController controller, string animName) : base(stateMachine, controller, animName)
    {
    }
