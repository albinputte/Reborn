...
public class IronGhostState : BaseEnemyState<IronGhostController>
{
    public static int WasAttacked;
    public static bool IsDamaged = false;
    public IronGhostState(EnemyStateMachine<IronGhostController> stateMachine, IronGhostController controller, string animName) : base(stateMachine, controller, animName)
    {
    }
